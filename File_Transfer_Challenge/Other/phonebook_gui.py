...
def load_gui(self):
    ...
    #DEFINE LABELS AND CORRESPONDING DIMENSIONS
    ...
    #DEFINE TEXT BOXES AND CORRESPONDING DIMENSIONS
    ...
    #DEFINE BUTTON WITH FUNCTIONS AND THEIR CORRESPONDING DIMENSIONS
